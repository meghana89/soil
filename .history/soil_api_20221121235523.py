...
import pandas as pd
from pycaret.time_series import load_model, predict_model, TSForecastingExperiment
...
def predict(data: input_model):
    ...
    predictions = exp.predict_model(model, data=data)
